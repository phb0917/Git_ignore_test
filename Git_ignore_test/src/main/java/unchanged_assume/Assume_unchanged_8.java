...
public class Assume_unchanged_8 {
	...
	*/
		...
		System.out.println("==== Assume_unchanged_8.java 파일 수정합니다. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일 또수정합니다. ===="); 
		System.out.println("==== Assume_unchanged_8.java 파일 완료합니다. ===="); 
